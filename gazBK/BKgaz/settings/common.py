...
INSTALLED_APPS = [
    ...
    'charcha.discussions',
    'charcha.teams',
    'social_django', # FIXME:  надо создать приложения гуглы и других соц сетей, для аутентификации, погулилите. Эта хрень использует
    # OAuth2
]
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = ('790115942597-75accl9rgiahrdu471ik4jah6stm1gkn.apps.googleusercontent.com')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET =('CdyOE4Y-HNkaDcWiZlSUbTPn')
